...
```terraform
module "platz" {
  source = "github.com/platzio/terraform-aws-platzio?ref=v0.5.3-beta.1/modules/main"
...
```terraform
module "platz_chart_discovery" {
  source = "github.com/platzio/terraform-aws-platzio?ref=v0.5.3-beta.1/modules/chart-discovery"
...
```terraform
module "platz_k8s_agent_role" {
  source = "github.com/platzio/terraform-aws-platzio?ref=v0.5.3-beta.1/modules/k8s-agent-role"
