...
```
module "platz" {
  source = "github.com/platzio/terraform-aws-platzio?ref=v0.4.8/modules/main"
...
module "platz_chart_discovery" {
  source = "github.com/platzio/terraform-aws-platzio?ref=v0.4.8/modules/chart-discovery"
...
```
module "platz_k8s_agent_role" {
  source = "github.com/platzio/terraform-aws-platzio?ref=v0.4.8/modules/k8s-agent-role"
