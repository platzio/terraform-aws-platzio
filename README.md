...
```terraform
module "platz" {
  source = "github.com/platzio/terraform-aws-platzio?ref=v0.7.0-beta.5/modules/main"
...
| `install_database`  |          | `true`          | Install a `postgresql` database chart by [groundhog2k/postgres](https://artifacthub.io/packages/helm/groundhog2k/postgres) (if `false`, you must provide `database_config`)                                                                                                                                                                                                                                                                                                       |
| `database_config`   |          |                 | Database connection parameters (ignored unless `install_database` is `false`)                                                                                                                                                                                                                                                                                                                                                                                                     |
| `database_pool`     |          | `{}`            | Tuning for the database connection pool shared by all Platz pods. Object with optional `max_size`, `min_idle`, `connection_timeout_secs`, `idle_timeout_secs`, `max_lifetime_secs`. Unset fields use built-in defaults (50 / 30s / 600s / 1800s).                                                                                                                                                                                                                                 |
...
```terraform
module "platz_chart_discovery" {
  source = "github.com/platzio/terraform-aws-platzio?ref=v0.7.0-beta.5/modules/chart-discovery"
...
```terraform
module "platz_k8s_agent_role" {
  source = "github.com/platzio/terraform-aws-platzio?ref=v0.7.0-beta.5/modules/k8s-agent-role"
